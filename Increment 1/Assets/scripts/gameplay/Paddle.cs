...
public class Paddle : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        freezeEffect = gameObject.AddComponent<Timer>();
        isFrozen = false;
    }
    ...
    public void FreezePaddleDuration(int time)
    {
        if (isFrozen)
        {
            freezeEffect.Add(time);
        }
        else
        {
            freezeEffect.Duration = ConfigurationUtils.FreezerEffectDuration;
        }
        freezeEffect.Run();
        isFrozen = true;
    }
